...
from data import DetectionDataset,Mix_DetectionDataset
import logging
...
def main(args):
    ...
    #     jsonl_file_path=data_train_path,
    #     image_directory_path=data_train_image_path,
    #     text = args.text,
    #     task = args.task
    # )
    # val_dataset = DetectionDataset(
    #     jsonl_file_path=data_val_path,
    #     image_directory_path=data_val_image_path,
    #     text = args.text,
    #     task = args.task
    # )

    train_dataset = Mix_DetectionDataset(
        jsonl_file_path1 = args.data_train_path_1,
        image_directory_path1 = args.data_train_image_path_1,
        text1 = args.text_1,
        task1 = args.task_1,
        jsonl_file_path2 = args.data_train_path_2,
        image_directory_path2 = args.data_train_image_path_2,
        text2 = args.text_2,
        task2 = args.task_2,
    )
    val_dataset = Mix_DetectionDataset(
        jsonl_file_path1 = args.data_val_path_1,
        image_directory_path1 = args.data_val_image_path_1,
        text1 = args.text_1,
        task1 = args.task_1,
        jsonl_file_path2 = args.data_val_path_2,
        image_directory_path2 = args.data_val_image_path_2,
        text2 = args.text_2,
        task2 = args.task_2,
    )
...
if __name__ == '__main__':
    ...
    # path
    parser.add_argument("--data_train_path_1", type=str, default="/root/autodl-tmp/Deep Learning/Logo-Detection/data/v1_records_refined_box_format.json", help="path to dataset")
    parser.add_argument("--data_train_image_path_1", type=str, default="/root/autodl-tmp/Deep Learning/Logo-Detection/data/v1_image", help="path to dataset")
    parser.add_argument("--data_val_path_1", type=str, default="/root/autodl-tmp/Deep Learning/Logo-Detection/data/v1_test_10.json", help="path to dataset")
    parser.add_argument("--data_val_image_path_1", type=str, default="/root/autodl-tmp/Deep Learning/Logo-Detection/data/v1_image", help="path to dataset")
    parser.add_argument("--data_train_path_2", type=str, default="/root/autodl-tmp/Deep Learning/Logo-Detection/data/v1_records_refined_box_format.json", help="path to dataset")
    parser.add_argument("--data_train_image_path_2", type=str, default="/root/autodl-tmp/Deep Learning/Logo-Detection/data/v1_image", help="path to dataset")
    parser.add_argument("--data_val_path_2", type=str, default="/root/autodl-tmp/Deep Learning/Logo-Detection/data/v1_test_10.json", help="path to dataset")
    parser.add_argument("--data_val_image_path_2", type=str, default="/root/autodl-tmp/Deep Learning/Logo-Detection/data/v1_image", help="path to dataset")
    ...
    parser.add_argument("--lora_alpha", type=int, default=8, help="learning lora_alpha")
    parser.add_argument("--lora_dropout", type=float, default=0.05, help="lora_dropout")

    # prompt
    parser.add_argument("--text_1", type=str, default='logo', help="prompt text")
    parser.add_argument("--task_1", type=str, default='<CAPTION_TO_PHRASE_GROUNDING>', help="prompt task")
    parser.add_argument("--text_2", type=str, default='logo', help="prompt text")
    parser.add_argument("--task_2", type=str, default='<CAPTION_TO_PHRASE_GROUNDING>', help="prompt task")
