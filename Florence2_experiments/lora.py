...
def main(args):
    ...
    data_train_image_path = args.data_train_image_path
    data_val_image_path = args.data_val_image_path
...
if __name__ == '__main__':
    ...
    # prompt
    parser.add_argument("--text", type=str, default='logo', help="prompt text")
    parser.add_argument("--task", type=str, default='<CAPTION_TO_PHRASE_GROUNDING>', help="prompt task")
